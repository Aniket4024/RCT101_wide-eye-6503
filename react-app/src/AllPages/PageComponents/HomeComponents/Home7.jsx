import eduxcelLightLogo from "../../../Images/DarkLogo.png"
        ...
        <Stack
          ...
          >
            <Heading
              ...
              >
              Subscribe To
             <img style={{marginTop:"-2px"}} width="200px" src={eduxcelLightLogo} alt="Eduxcel Logo" />
            </Heading>
            <div style={{width:"100%",border:"1px solid rgb(0,208,180",margin:"-40px auto 0px auto"}}></div>
          <Stack style={{marginTop:"0px"}}  align={'center'} spacing={2}>
            <Text fontSize={'lg'} color={'gray.500'}>
              Subscribe to our newsletter & stay up to date!
            </Text>
          </Stack>
          <Stack spacing={4} gap={20} style={{marginTop:"20px"}} direction={{ base: 'column', md: 'row' }} w={'full'}>
            <Input
                style={{
                    height:theme?"47.6px":"45px",
                    width:"340px",
                    borderRadius:"20px",
                    fontSize:"18px",
